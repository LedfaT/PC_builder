export const styles = {
  ...
  searchContainer:
    "flex items-center bg-white px-3 py-1.5 rounded-full shadow-sm flex-shrink-0",
  searchInput:
    "ml-2 outline-none text-sm w-40 placeholder:text-sm placeholder:text-gray-400",
};
